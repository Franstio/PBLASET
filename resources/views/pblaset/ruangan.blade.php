  ...
  <body class="">
    ...
    <div class="main-content">
      ...
      <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
          <!-- Brand -->
          <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="DBR.html">Daftar Barang Ruangan (Ruangan)</a>
          <!-- Form -->
          <!-- User -->
          ...
          <div class="header-body">
            <!-- Card stats -->
              <div class="dropdown">
                ...
                <a class="btn btn-secondary" href="lantai.html" role="button">Lantai</a>
                <a class="btn btn-secondary active" href="ruangan.html" role="button">Ruangan</a>
