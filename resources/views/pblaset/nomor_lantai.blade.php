  ...
  <body class="">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item active">
              <a class="nav-link active" href="l_ruangan.html"> <i class="ni ni-pin-3 text-orange"></i> List Ruangan </a>
            </li>
            <li class="nav-item">
    ...
    <div class="main-content">
      ...
      <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
          <!-- Brand -->
          <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="nomor_lantai.html">List Ruangan (Nomor Lantai)</a>
          <!-- Form -->
          <!-- User -->
        ...
        <div class="container-fluid">
          <div class="header-body">
            ...
            <div class="dropdown">
              ...
              <a class="btn btn-secondary" href="l_ruangan.html" role="button">Nama Gedung</a>
              <a class="btn btn-secondary active" href="nomor_lantai.html" role="button">Nomor Lantai</a>
                    ...
                    <div class="modal-body">
                      <!-- Default form contact -->
                        <form class="text-center border border-light p-5" action="#!">
                          <input type="text" id="defaultContactFormEmail" class="form-control mb-4" placeholder="Nomor Lantai">
                        </form>
                        <!-- Default form contact -->
                    </div>
